...
% finds RPE boundary using Dijsktra minimal path on the dark to bright
% gradient in y direction

function [phi cost coor] = minimal_path2 (image, E, N, ONH2)
...
%     % ONH area of no importantance so path is set to have low values here
    % Gy(ONH2==1) = 10^-10;
